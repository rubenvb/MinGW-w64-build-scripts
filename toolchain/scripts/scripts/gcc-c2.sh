...
touch gcc-c2_configure.marker

if [ -f gcc-c2_build.marker ]
then
    echo "--> Already built"
else
    echo "--> Building"
...
touch gcc-c2_build.marker

if [ -f gcc-c2_install.marker ]
then
