...
if [ -f $MARKER_DIR/expat_configure.marker ]
then
...
touch $MARKER_DIR/expat_configure.marker

if [ -f $MARKER_DIR/expat_build.marker ]
then
    echo "--> Already built"
else
    echo "--> Building"
...
touch $MARKER_DIR/expat_build.marker
if [ -f $MARKER_DIR/expat_install.marker ]
then
...
touch $MARKER_DIR/expat_install.marker
